   ...
   getinfo = async () => {
        ...
        try {
            ...
            const api_call = await fetch(
                `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=plant+cancer+thyroid+herb&api_key=${API_KEY}&usehistory=y`
            );
...
<div class="container">
        ...
        <div class="cancer_info">
                ...
                <div >Thyroid cancer is the most common cancer in women 20 to 34. It is estimated that 2,060 deaths (960 men and 1,100 women) from this disease will occur this year. Women are 3 times more likely to have thyroid cancer than men, but women and men die at similar rates. This suggests that men have a worse prognosis than women when there is a diagnosis of thyroid cancer.
