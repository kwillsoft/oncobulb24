...
getinfo = async () => {
    ...
    const api_call = await fetch(
        `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=pancreatic+cancer+herb+plant&api_key=${API_KEY}&usehistory=y`
    );
    ...
    if (data) {
        ...
        const api_callb = await fetch(
            `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pubmed&retmax=20&api_key=${API_KEY}&retstart=3&retmode=json&rettype=abstract&query_key=${Query_Key}&WebEnv=${Web_Env}`
        );
...
<div class="container">
            <div id="top_box" >
                <div ><img class="cancerimg" src="img/pancreas.jpg"></div>
            </div>
        ...
        <div class="cancer_info">
                ...
                <div >It is estimated that 44,330 deaths (23,020 men and 21,310 women) from this disease will occur this year. Pancreatic cancer is the eighth most common cancer in women and the fourth leading cause of cancer death in men and women.
