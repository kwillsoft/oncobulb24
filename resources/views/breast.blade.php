...
getinfo = async () => {
        ...
        try {
            ...
            const api_call = await fetch(
                `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=plant+cancer+breast+herb+NOT+id=33634751&api_key=${API_KEY}&usehistory=y`
            );
