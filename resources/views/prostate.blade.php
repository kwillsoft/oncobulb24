...
getinfo = async () => {
    ...
    const api_call = await fetch(
        `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=prostate+cancer+herb+plant&api_key=${API_KEY}&usehistory=y`
    );
    ...
    if (data) {
        ...
        const api_callb = await fetch(
            `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/efetch.fcgi?db=pubmed&retmax=20&api_key=${API_KEY}&retstart=4&retmode=json&rettype=abstract&query_key=${Query_Key}&WebEnv=${Web_Env}`
        );
...
<div class="container">
        ...
        <div class="cancer_info">
                ...
                <div >Prostate cancer is the second leading cause of cancer death in men in the United States. It is estimated that 29,430 deaths from this disease will occur this year. Although the number of deaths from prostate cancer continues to decline among all men, the death rate remains twice as high in black men than any other group.
