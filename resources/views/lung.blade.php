...
getinfo = async () => {
    ...
    const api_call = await fetch(
        `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=lung+cancer+herb+plant&api_key=${API_KEY}&usehistory=y`
    );
...
<div class="container">
            <div id="top_box" >
                <div ><img class="cancerimg" src="img/lung.jpg"></div>
            </div>
        ...
        <div class="cancer_info">
                ...
                <div >Lung cancer is by far the leading cause of cancer death among both men and women Each year, more people die of lung cancer than of colon, breast, and prostate cancers combined.
