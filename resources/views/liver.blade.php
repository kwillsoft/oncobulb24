    ...
    getinfo = async () => {
        ...
        try {
            ...
            const api_call = await fetch(
                `https://eutils.ncbi.nlm.nih.gov/entrez/eutils/esearch.fcgi?db=pubmed&retmax=20&term=plant+cancer+liver+hepatic+herb&api_key=${API_KEY}&usehistory=y`
            );
...
<div class="container">
            <div id="top_box" >
                <div ><img class="cancerimg" src="img/liver.jpg"></div>
            </div>
        ...
        <div class="cancer_info">
                ...
                <div >For men, liver cancer is the 10th most common cancer and the 5th most common cause of cancer death. It is also the 8th most common cause of cancer death among women. 
                    Survival rates depend on several factors, including the stage of the disease.
                </div>
